...
public:
	...
	glm::mat4 getLookAt() const { return glm::lookAt(camera_position_, target_position_, UP_DIR); }
...
const glm::vec3 Camera::UP_DIR = glm::vec3(0.f, 1.f, 0.f);
